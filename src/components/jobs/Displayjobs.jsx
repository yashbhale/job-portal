...
const Displayjobs = () => {
  ...
  useEffect(() => {
    const analyzeResume = async () => {
      try {
        await fetch("http://localhost:5001/api/v1/ai/analyze-resume", {
          method: "GET",
          credentials: "include",
        });
      } catch (error) {
              ...
              >
                <div className="p-6">
                  ...
                  <div className="mt-6 flex space-x-3">
                    ...
                    <button className="flex-1 bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 font-medium py-2 px-4 rounded-lg transition-colors duration-300">
                      Save
                    </button>
                  </div>
                </div>
